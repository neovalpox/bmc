...
if($new_date[0] == date("Y-m-d")) {
	echo "Aujourd'hui </b>&agrave; <b>".$new_date[1]."</b><br> par <b>".$user_name."</b>";
} else if($new_date[0] == date("Y-m-d")-1) {
	echo "Hier </b> &agrave; <b>".$new_date[1]."</b><br> par <b>".$user_name."</font></b>";
	echo "Hier</b> &agrave; <b>".$new_date[1]."</b><br> par <b>".$user_name."</font></b>";
} else {
	echo "le ".$new_date[0]."</b> &agrave; <b>".$new_date[1]."</b><br> par <b>".$user_name."</b>";
}
?>
